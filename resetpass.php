...
<?php
    echo "<div class='formbg-outer'>
            <div class='formbg'>
                ...
                <div class='mb-3'>
                <form action='restotp.php' method='post' class='mt-4'>
                    <center>
                    ...
                    <div class='mb-3'>
                        <label for='txn_id' class='form-label'>Enter New Pasword:</label>
                        <input type='text' id='pass' placeholder='Enter New Your Pasword' name='pass' class='form-control' required>
                    </div>
                    <center>
