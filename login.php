        ...
        if ($result->num_rows === 1) {
            ...
            if ($password === $userData["password"]) {
                if ($verified == "1") {
                    ...
                    echo "<script>alert('Please Verify Your email to Login');</script>";
                }
            } else {
                echo "<script>alert('Login Failed ! Invalid Email or password Please Try Again');</script>";
            }
        } else {
            echo "<script>alert('Email is not Registred Register Now'); window.location.href = 'index.php';</script>";
        }
    }
